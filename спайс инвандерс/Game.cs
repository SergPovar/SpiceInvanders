...
public class Game
{
    ...
    public Game(GameConfiguration gameConfiguration)
    {
        ...
        _enemyManager = new EnemyManager(gameConfiguration.EnemySpawnCooldown, gameConfiguration.EnemySpeed, _screenSize,
            _animationManager);
    ...
    {
        var shootingColDown = gameConfiguration.PlayerSettings.ShootingCooldown;
        var shootingManager =
            new ShootingManager(shootingColDown, gameConfiguration.BulletSpeed, gameConfiguration.BulletRadius);
    ...
    {
        var screenCenter = new Vector2f((uint)gameConfiguration.Width / 2f, (uint)gameConfiguration.Height / 2f);
